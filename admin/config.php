<?php
// HTTP
define('HTTP_SERVER', 'http://182.92.123.78/admin/');
define('HTTP_CATALOG', 'http://182.92.123.78/');

// HTTPS
define('HTTPS_SERVER', 'http://182.92.123.78/admin/');
define('HTTPS_CATALOG', 'http://182.92.123.78/');
...
define('DB_USERNAME', 'jiangwei_test');
define('DB_PASSWORD', 'jiangwei_test');
define('DB_DATABASE', 'mcc_db');
define('DB_PORT', '3306');
